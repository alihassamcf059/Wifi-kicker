...
"""
Copyright (C) 2018-19 Ali Hassam (https://orka-tech.com)
"""
...
def heading():
   ...
   ____       _                _            _                          
 / __ \     | |              | |          | |                         
| |  | |_ __| | ____ _ ______| |_ ___  ___| |__    ___ ___  _ __ ___  
| |  | | '__| |/ / _` |______| __/ _ \/ __| '_ \  / __/ _ \| '_ ` _ \ 
| |__| | |  |   < (_| |      | ||  __/ (__| | | || (_| (_) | | | | | |
 \____/|_|  |_|\_\__,_|       \__\___|\___|_| |_(_)___\___/|_| |_| |_|
                                                                      

    """ + END + BLUE +
'\n' + '{}Kick Devices Off Your LAN ({}KickThemOut{}){}'.format(YELLOW, RED, YELLOW, BLUE).center(98) +
'\n' + 'Made With <3 by: {0}Ali Hassam '.format(YELLOW, RED, YELLOW, BLUE).center(98) +
